...
echo 'Welcome Back, Jason'|toilet -f pagga.tlf -F border --metal
/usr/bin/fortune -a|cowsay
/home/jwu/python/holiday.py

export GOROOT=/usr/lib/golang
export GOPATH=/home/jwu/go
